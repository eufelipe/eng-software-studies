			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Princípio da Responsabilidade Única (SRP)', slug: 'solid/srp' },
						{ label: 'Princípio Aberto/Fechado (OCP)', slug: 'solid/ocp' },
						{ label: 'Princípio da Substituição de Liskov (LSP)', slug: 'solid/lsp' },
						{ label: 'Princípio da Segregação de Interfaces (ISP)', slug: 'solid/isp' },
						{ label: 'Princípio da Inversão de Dependência (DIP)', slug: 'solid/dip' },
					],
				},
				{
					label: 'Guia de Estudos de Design Patterns',
					items: [
						{ label: 'Por que Design Patterns?', slug: 'design-patterns/why-design-patterns' },
				...
				},
				{
					...
					items: [
						{ label: 'Por que Arquitetura de Software?', slug: 'architecture/why-architecture' },
						{ label: 'Arquitetura em Camadas', slug: 'architecture/layered' },
						{ label: 'Arquitetura Hexagonal', slug: 'architecture/hexagonal' },
						{ label: 'Arquitetura Orientada a Eventos', slug: 'architecture/event-driven' },
